...
{
    public class FebestAirСonditioningСompressors : AirСonditioningСompressors
    {
        public FebestAirСonditioningСompressors(string Name, string Length, string Height, int NumberOfRibs,
