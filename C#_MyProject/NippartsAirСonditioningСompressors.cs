...
{
    public class NippartsAirСonditioningСompressors : AirСonditioningСompressors
    {
        public NippartsAirСonditioningСompressors(string Name, string Length, string Height, int NumberOfRibs, 
