...
{
    public class SKFAirСonditioningСompressors : AirСonditioningСompressors
    {
        public SKFAirСonditioningСompressors(string Name, string Length, string Height, int NumberOfRibs,
