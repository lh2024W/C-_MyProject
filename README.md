...
8. Добавить товар. Для этого нужно выбрать категорию товара и согласно категорию и ввести необходимые данные о товаре.(Категории: Детали ходовой, Детали электричества, Детали выхлопной системы, Система кондеционирования, Детали двигателя).
